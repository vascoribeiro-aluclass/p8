...
class CpaTypeDimensionsSelect extends CpaFields
{
    ...
    public function processField()
    {
        ...
        if (count($arraydimensions) > 0) {
            $fieldValues[0]["min_dimensions"] = $arraydimensions[0]["min_height"];
            $fieldValues[0]["max_dimensions"] = $arraydimensions[0]["max_height"];
            $fieldValues[1]["min_dimensions"] = $arraydimensions[0]["min_width"];
            $fieldValues[1]["max_dimensions"] = $arraydimensions[0]["max_width"];
