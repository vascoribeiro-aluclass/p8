        ...
        {foreach from=$features item=feature}
          {if $feature.id_feature == $field.feature && isset($feature.value)}
            <span class="radio">
              ...
              <label id="descriptionimg_{$value.id_cpa_customization_field_value}">{$feature.value|escape:'htmlall':'UTF-8'}({l s='by default'  mod='ndk_advanced_custom_fields'})</label>
            </span>
          {/if}
