<div class="block " id="cpafields-block" data-key="{$id_product}">
    <div id="productprogressbarfluid" style="height: 88px;">
        <div id="productprogressbar" style="height: 88px; background: rgb(255, 255, 255);">
			...
			box-shadow: 0 0 7px #dedede;padding: 8px 8px 8px 8px !important;">
                <h2 style="font-size: 1rem;"> {l s='Estado da sua personalização' mod='cpacustomizadorprodutosaluclass'} </h2>
                <div class="progress">
                    <span class="progress-text-begin">{l s='Processo : 0%' mod='cpacustomizadorprodutosaluclass'}  </span>
    ...
    <form id="cpafields" class="ajax_form" action="http://localhost/p8/modules/cpacustomizadorprodutosaluclass/">
        ...
        <div class="form-group clearfix box-info-product submitContainer">
            <button class="btn btn-primary submitCpafields " form="cpafields" id="submitCpafields"
