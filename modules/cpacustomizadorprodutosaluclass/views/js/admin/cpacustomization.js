...
$(document).ready(function () {
    ...
    if (typeof already_selected_fields_influence_percentage !== 'undefined' && already_selected_fields_influence_percentage.length) {
        var ids = $.map(already_selected_fields_influence_percentage, function (item) {
            return item.id;
        });

        $('.ajax-cpa-fields-percentage-search').val(ids.join(','));
    }
    ...
    $('.ajax-cpa-fields-percentage-search').select2({
        width: '100%',
        multiple: true,
        ...
        initSelection: function (element, callback) {
            if (typeof already_selected_fields_influence_percentage !== 'undefined') {
                callback(already_selected_fields_influence_percentage);
            }
        }
    });
